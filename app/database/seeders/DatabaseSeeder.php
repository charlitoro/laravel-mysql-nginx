...
class DatabaseSeeder extends Seeder
{
	...
	private function seedUsers(){
		...
		$user = new User;
		$user->name = 'Charli Toro';
		$user->email = 'charli@gmail.com';
		$user->password = bcrypt('charli_toro12');
		$user->save();

		$userTwo = new User;
		$userTwo->name = 'Anes Guerrero';
		$userTwo->email = 'anes@gmail.com';
		$userTwo->password = bcrypt('anes_g12');
		$userTwo->save();
	}
    ...
    private $arrayPeliculas = array(
		array(
			...
			'poster' => 'https://vignette.wikia.nocookie.net/padrinos/images/3/3e/El_Padrino_Parte_1-Caratula.jpg/revision/latest?cb=20120405120844&path-prefix=es', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1974', 
			'director' => 'Francis Ford Coppola', 
			'poster' => 'https://vignette.wikia.nocookie.net/cine/images/e/e4/Godfather-Part-II-1974.jpg/revision/latest/top-crop/width/360/height/450?cb=20121016224430', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://static.megustaleer.com/images/libros_650_x/EBB40957.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://e00-expansion.uecdn.es/assets/multimedia/imagenes/2020/03/26/15852179038912.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://pics.filmaffinity.com/Seven-800218653-large.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://vignette.wikia.nocookie.net/cine/images/b/b0/Clockwork_Orange-1971.jpg/revision/latest/top-crop/width/360/height/450?cb=20121003014917', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1976', 
			'director' => 'Martin Scorsese', 
			'poster' => 'https://pics.filmaffinity.com/Taxi_Driver-559150579-mmed.jpg', 
			'rented' => false, 
